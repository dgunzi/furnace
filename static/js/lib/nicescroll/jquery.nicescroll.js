...
(function(jQuery){
 ...
 // console.log(scriptpath+'-----------'+rootPath);
  ...
  var _globaloptions = {
      ...
      cursoropacitymin:0,
      cursoropacitymax:1,
	  cursorbackground:'url(images/ui3.3/scrollBg.png) center no-repeat',
	  horizrailbackground:'url(images/ui3.3/scrollBg.png) center no-repeat',
      cursorcolor:"#424242",
      cursorwidth:"5px",
...
//      cursormaxheight:false,
 ...
 //   this.opt = $.extend({},_globaloptions,this.opt);
...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        cursor.css({
		  ...
		  'background':self.opt.cursorbackground,
          ...
          'border-radius':self.opt.cursorborderradius
	        	...
	        	$(this).css({
	        		...
	        		'outline':'none',
					'box-shadow':'0 0 3px 1px #FFA303 inset'
	        	});
        	},function(){
        		$(this).css({
					'box-shadow':'none'
...
// init HORIZ
        ...
        if (self.opt.horizrailenabled) {
          ...
          cursor.css({
            ...
            'background':self.opt.horizrailbackground,
            'background-color':self.opt.cursorcolor,
            border:self.opt.cursorborder,
            'background-clip':'padding-box',
            '-webkit-border-radius':self.opt.cursorborderradius,
...
*/  
  ...
  $.fn.niceScroll = function(wrapper,opt) {        
    ...
    this.each(function() {
      ...
      ret.push(nice);
  //    $(this).on('mouseover.refreshScroll',function(){
    //	  console.log($(this).getNiceScroll().length);
    //	  $(window).resize();
